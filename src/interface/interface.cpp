...
bool Interface::try_apply_function(std::string text)
{
    ...
    else if (name == "local_expansions_mp")
    {
        this->local_expansions_mp(rest);
        return true;
    }
    ...
    else if (name == "norm_growth_mp")
    {
        this->norm_growth_mp(rest);
        return true;
    }
    ...
    else if (name == "rest_norm2_mp")
    {
        this->rest_norm2_mp(rest);
        return true;
    }
    ...
    else if (name == "numerical_expansions_mp")
    {
        this->numerical_expansions_mp(rest);
        return true;
    }
...
void Interface::local_expansions_mp(std::string text)
{
    // Initialize calculation
    auto args = find_function_arguments(text);
    int number_of_arguments = 7;
...
void Interface::norm_growth_mp(std::string text)
{
    // Initialize calculation
    auto args = find_function_arguments(text);
    int number_of_arguments = 7;
...
void Interface::rest_norm2_mp(std::string text)
{
    // Initialize calculation
    auto args = find_function_arguments(text);
    int number_of_arguments = 6;
...
void Interface::numerical_expansions_mp(std::string text)
{
    // Initialize calculation
    auto args = find_function_arguments(text);
    int number_of_arguments = 10;
    if (args.size() < number_of_arguments)
        ...
        throw std::invalid_argument("too much arguments for local_expansions_mp");
